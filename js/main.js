...
btnPizza.addEventListener("click", async function () {
  fetchData("pizza");
});

const btnPasta = document.getElementById("btn-pasta");
btnPasta.addEventListener("click", async function () {
  fetchData("pasta");
});

const btnCorn = document.getElementById("btn-corn");
btnCorn.addEventListener("click", async function () {
  fetchData("corn");
});
